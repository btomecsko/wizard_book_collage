...
wizard1 = Wizard.create(first: "Harry", last:"Potter", house:"Gryffindor")
wizard2 = Wizard.create(first: "Hermione", last:"Granger", house:"Gryffindor")
wizard3 = Wizard.create(first: "Ron", last:"Weasley", house:"Gryffindor")
wizard4 = Wizard.create(first: "Luna", last:"Lovegood", house:"Ravenclaw")
wizard5 = Wizard.create(first: "Newton", last:"Scamander", house:"Hufflepuff")
wizard6 = Wizard.create(first: "Nymphadora", last:"Tonks", house:"Hufflepuff")
